-- Создать представление (view), содержащее поля: рег. № и время, фамилия пользователя и
-- название задачи, накладные расходы, количество операций и общие затраты. Обеспечить
-- возможность изменения накладных расходов. При этом должны быть пересчитаны общие
-- затраты.
